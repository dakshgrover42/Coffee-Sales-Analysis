...
# VIEWING THE STRUCTURE OF META DATA :
...
# VIEWING THE FINAL TABLE WITH RECTIFIED DATA TYPES OF DIFFERENT COLUMNS :
DESCRIBE coffee_shop_sales;
...
# TOTAL SALES KPI - MONTH ON MONTH (MOM) DIFFERENCE AND MONTH ON MONTH GROWTH :
SELECT 
...
# TOTAL ORDERS KPI - MONTH ON MONTH (MOM) DIFFERENCE AND MONTH ON MONTH GROWTH :
SELECT 
    MONTH(transaction_date) AS month,
...
#TOTAL QUANTITY SOLD KPI - MONTH ON MONTH (MOM) DIFFERENCE AND MONTH ON MONTH GROWTH :
SELECT 
    MONTH(transaction_date) AS month,
